...
const onSmallerButtonClick = () => scaleImage(Math.max(parseInt(scaleInputElement.value, 10) - SCALE_STEP, MIN_SCALE));
const onBiggerButtonClick = () => scaleImage(Math.min(parseInt(scaleInputElement.value, 10) + SCALE_STEP, MAX_SCALE));
